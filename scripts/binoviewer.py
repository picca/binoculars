...
from guidata.qt.QtGui import (qApp,QCheckBox,QVBoxLayout,QHBoxLayout,QGridLayout,QLabel,QLineEdit,QKeyEvent,QWidget,QSlider,
                              QSpinBox,QDoubleSpinBox,QColor,QComboBox,QAction,QMenu,QMenuBar,QProgressBar,QPolygonF,
...
from guiqwt.signals import (SIG_ITEMS_CHANGED,SIG_STOP_NOT_MOVING,SIG_MOVE,SIG_STOP_MOVING,
