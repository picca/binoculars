...
def linear2D(x,slope_x=0.,slope_y=0.,bg=0.):
    return (bg+x[0]*slope_x+x[1]*slope_y)

"""*****************************************************************************************************"""
def lorenzianpower2D(x, amp=1., loc0=0., loc1=0., width0=1., width1=1., th=0., power=2.):
    cth=np.cos(th)
    sth=np.sin(th)
    x0=x[0]-loc0
    x1=x[1]-loc1
...
def lorenzianpower(y, x, amp=1., loc0=0., loc1=0., width0=1., width1=1., th=0., power=2.):
    cth=np.cos(th)
    sth=np.sin(th)
    x0=x-loc0
    x1=y-loc1
...
def lorenzianpowerint(amp=1., loc0=0., loc1=0., width0=1., width1=1., th=0., power=2.):
    return dblquad(lambda y, x: lorenzianpoly(y,x,amp,loc0,loc1,width0,width1,th,power), -np.inf, np.inf, lambda x: -np.inf, lambda x: np.inf)

"""*****************************************************************************************************"""        
def lorenziangauss2D(x, amp=1., loc0=0., loc1=0., width0=1., width1=1., th=0.):
    cth=np.cos(th)
    sth=np.sin(th)
    x0=x[0]-loc0
    x1=x[1]-loc1
...
def lorenziangaussint(amp=1., loc0=0., loc1=0., width0=1., width1=1., th=0.):
    return  (amp*np.pi*np.sqrt(np.pi)*width0*width1,0.)

"""*****************************************************************************************************"""    
def lorenzianpoly2D(x, amp=1., loc0=0., loc1=0., width0=1., width1=1., eta0=1., eta1=1., th=0.):
...
def lorenzianpoly(y, x, amp=1., loc0=0., loc1=0., width0=1., width1=1., eta0=1., eta1=1., th=0.):
...
def lorenzianpolyint(amp=1., loc0=0., loc1=0., width0=1., width1=1., eta0=1., eta1=1., th=0.):
    return dblquad(lambda y, x: lorenzianpoly(y,x,amp,loc0,loc1,width0,width1,eta0,eta1,th), -np.inf, np.inf, lambda x: -np.inf, lambda x: np.inf)
"""*****************************************************************************************************"""    
def lorenziandoor2D(x, amp=1., loc0=0., loc1=0., width0=1., width1=1., eta=1., th=0.):
    cth=np.cos(th)
    sth=np.sin(th)
    x0=x[0]-loc0
    x1=x[1]-loc1
...
def lorenziandoorint(amp=1., loc0=0., loc1=0., width0=1., width1=1., eta=1., th=0.):
...
class Model(LmfitModel):
    def __init__(self, func, independent_vars=None, param_names=None,
        ...
        super(Model,self).__init__(func=func, independent_vars=independent_vars, param_names=param_names,
...
class LorenzianPower2DModel(Model):
    ...
    def __init__(self, independent_vars=['x'], prefix='', nan_policy='raise',
        ...
        super(LorenzianPower2DModel, self).__init__(lorenzianpower2D, param_names=['amp', 'loc0', 'loc1', 'width0', 'width1', 'th', 'power'], **kwargs)
    ...
    def guess(self, data, x=None, **kwargs):
        ...
        if x is not None:
            ...
            loc0 = x[0][n]
            loc1 = x[1][n]
            width0 = (np.amax(x)-np.amin(x))/2.
            width1 = (np.amax(x)-np.amin(x))/2.
            if width0 == 0:
                width0 = 1.
            if width1 == 0:
                width1 = 1.                
...
class LorenzianPoly2DModel(Model):
    ...
    def __init__(self, independent_vars=['x'], prefix='', nan_policy='raise',
        ...
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
        super(LorenzianPoly2DModel, self).__init__(lorenzianpoly2D, param_names=['amp', 'loc0', 'loc1', 'width0', 'width1', 'eta0', 'eta1', 'th'], **kwargs)
        self.set_param_hint('amp', value=1.)
        self.set_param_hint('loc0', value=0.)
        self.set_param_hint('loc1', value=0.)
        self.set_param_hint('width0', value=1., min=0)
...
class LorenzianDoorModel(Model):
    ...
    def __init__(self, independent_vars=['x'], prefix='', nan_policy='raise',
        ...
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
        super(LorenzianDoorModel, self).__init__(lorenziandoor2D, param_names=['amp', 'loc0', 'loc1', 'width0', 'width1', 'eta', 'th'], **kwargs)
        self.set_param_hint('amp', value=1.)
        self.set_param_hint('loc0', value=0.)
        self.set_param_hint('loc1', value=0.)
        self.set_param_hint('width0', value=1., min=0)
...
class LorenzianGaussModel(Model):
    ...
    def __init__(self, independent_vars=['x'], prefix='', nan_policy='raise',
        ...
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
        super(LorenzianGaussModel, self).__init__(lorenziangauss2D, param_names=['amp', 'loc0', 'loc1', 'width0', 'width1', 'th'], **kwargs)
        self.set_param_hint('amp', value=1.)
        self.set_param_hint('loc0', value=0.)
        self.set_param_hint('loc1', value=0.)
        self.set_param_hint('width0', value=1., min=0)
...
class Linear2DModel(Model):
    ...
    def __init__(self, independent_vars=['x'], prefix='', nan_policy='raise',
        ...
        kwargs.update({'prefix': prefix, 'nan_policy': nan_policy,
                       'independent_vars': independent_vars})
        super(Linear2DModel, self).__init__(linear2D, param_names=['bg','slope_x','slope_y'], **kwargs)
...
list_of_models = []
list_of_2D_models = [Linear2DModel,LorenzianGaussModel,LorenzianPoly2DModel,LorenzianPower2DModel,LorenzianDoorModel]