...
space = binoculars.load("/nfs/ruche-sixs/sixs-soleil/com-sixs/2022/Run5/20220739_kutyla/binoculars/map_q127-127.hdf5")
...
binoculars.save("test.txt", specular)
